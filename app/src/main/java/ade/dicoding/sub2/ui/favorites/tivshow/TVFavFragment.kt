 ...
 */
class TVFavFragment : Fragment(), TVFavAdapter.CallbackAdapter {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            viewModel =
                ViewModelProviders.of(activity!!, factory).get(TVFavViewModel::class.java)
            initAdapter()
            setSearching()
    ...
    private fun initAdapter() {
        ...
        adapter = TVFavAdapter(activity, this)
        rv_list.apply {
            layoutManager = LinearLayoutManager(context)
            setHasFixedSize(true)
            adapter = this@TVFavFragment.adapter
        }
    ...
    override fun clicked(item: TVDetailEntity?) {
