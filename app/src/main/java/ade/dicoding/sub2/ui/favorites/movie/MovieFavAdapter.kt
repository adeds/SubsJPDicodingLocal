...
class MovieFavAdapter(
    ...
    PagedListAdapter<MovieDetailEntity, MovieFavAdapter.Holder>(DIFF_CALLBACK)
{
    ...
    companion object {
        private val DIFF_CALLBACK: DiffUtil.ItemCallback<MovieDetailEntity> =
            object : DiffUtil.ItemCallback<MovieDetailEntity>() {

                override fun areItemsTheSame(
                    oldNote: MovieDetailEntity,
                    newNote: MovieDetailEntity
                ): Boolean {
    ...
    interface CallbackAdapter {
        fun clicked(item: MovieDetailEntity?)
    }
